                            ...
                            <div class="anis-watch anis-watch-tv">
                                <div class="watch-player">
                                    <div class="player-frame">
                                        ...
                                        <!---recommended to use Animegers Servers only ---->
                                        <iframe name="iframe-to-load"
                                            src="https://player.animegers.com?id=<?= $url ?>" frameborder="0"
                                            scrolling="no"
                                    ...
                                    <div id="servers-content">
                                        <div class="ps_-status">
                                            <div class="content">
                                                <div class="server-notice"><strong>Currently watching <b>Episode
                                                    ...
                                                    servers in case of error or contact us in our discord.</div>
                                            </div>
                                        </div>
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            ...
                                            <div class="ps__-list">
                                                <div class="item">
                                                    <a id="default" 
                                                 href="https://player.animegers.com?id=<?= $url ?>"
                                                        target="iframe-to-load" class="btn btn-server active">Default</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server1"
                                                        href="https://server1.animegers.com?id=<?= $url ?>"
                                                        target="iframe-to-load" class="btn btn-server">Server 1</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2"
                                                        href="https://server2.animegers.com?id=<?= $url ?>"
                                                        target="iframe-to-load" class="btn btn-server">Server 2</a>
                                                </div>
                                                <div class="item">
                                                    <a id="vidstream"
                                                        href="/player/emergencyplayer/v1.php?id=<?= $url ?>"
                                                        target="iframe-to-load" class="btn btn-server">Vidstream</a>
                                                </div>
