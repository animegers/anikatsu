                ...
                <div class="ani_detail-stage">
                    <div class="container">
                        <div class="anis-cover-wrap">
                            <div class="anis-cover" style="background-image: url('<?= $websiteUrl ?>/files/images/banner.webp')">
                            </div>
                        </div>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item" aria-current="page">
                                            <a itemprop="item" href="/anime/<?= $animeID ?>"><span itemprop="name"><?= $anime['name'] ?></span></a>
                                            <meta itemprop="position" content="3">
                                        </li>
                                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item" aria-current="page">
                                            <a itemprop="item" href="<?= $websiteUrl ?>/watch/<?= $url ?>"><span itemprop="name">Episode <?= $EPISODE_NUMBER ?></span></a>
                            ...
                            <div class="anis-watch anis-watch-tv">
                                <div class="watch-player">
                                    <div class="player-frame">
                                        ...
                                        <iframe name="iframe-to-load" src="https://player.animegers.com?id=<?= $url ?>" frameborder="0" scrolling="no" allow="accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                                    </div>
                                ...
                                <div class="player-servers">
                                    <div id="servers-content">
                                        <div class="ps_-status">
                                            <div class="content">
                                                <div class="server-notice"><strong>Currently watching <b>Episode <?= $EPISODE_NUMBER ?></b></strong> Switch to alternate servers in case of error or contact us in our discord.</div>
                                            </div>
                                        </div>
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            <div class="ps__-title"><i class="fas fa-server mr-2"></i>SUB SVR:</div>
                                            <div class="ps__-list">
                                                <div class="item">
                                                    <a id="default" href="https://player.animegers.com?id=<?= $url ?>" target="iframe-to-load" class="btn btn-server active">Default</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server1" href="https://server1.animegers.com?id=<?= $url ?>" target="iframe-to-load" class="btn btn-server">Server 1</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2" href="https://server2.animegers.com?id=<?= $url ?>" target="iframe-to-load" class="btn btn-server">Server 2</a>
                                                </div>
                                                <div class="item">
                                                    <a id="vidstream" href="/player/emergencyplayer/v1.php?id=<?= $url ?>" target="iframe-to-load" class="btn btn-server">Vidstream</a>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        ...
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            <div class="ps__-title"><i class="fas fa-server mr-2"></i>DUB SVR:</div>
                                            <div class="ps__-list">
                                                <div class="item">
                                                    <a id="default" href="https://player.animegers.com?id=<?= $url ?>" target="iframe-to-load" class="btn btn-server active">Default</a>
                                                </div>
                                            ...
                                            <div class="detail-infor-content">
                                                ...
                                                <div id="episodes-page-1" class="ss-list ss-list-min" data-page="1" style="display:block;">
                                                    <?php foreach ($episodeList as $episode) { ?>
                                                        <a title="Episode <?= $episode['number'] ?>" class="ssl-item ep-item <?php if ($EPISODE_NUMBER == $episode['number']) { echo 'active'; } ?>" href="/watch/<?= $episode['episodeId'] ?>">
